...
describe("growUp", () => {
  it("throws an error if fitness is less than or equal to 0", () => {
    const pet = new Pet("Fido");
    pet.fitness = 0;
    expect(() => pet.growUp()).toThrow("Your pet is no longer alive :(");
  });

  it("throws an error if hunger is greater than or equal to 10", () => {
    const pet = new Pet("Fido");
    pet.hunger = 10;
    expect(() => pet.growUp()).toThrow("Your pet is no longer alive :(");
  });

  it("throws an error if age is greater than or equal to 30", () => {
    const pet = new Pet("Fido");
    pet.age = 30;
    expect(() => pet.growUp()).toThrow("Your pet is no longer alive :(");
  });
